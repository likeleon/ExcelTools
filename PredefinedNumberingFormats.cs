...
namespace ExcelTools
{
    ...
    /// </summary>
    public static class PredefinedNumberingFormats
    {
        private static readonly Lazy<IReadOnlyDictionary<int, string>> _lazyFormatCodes = new Lazy<IReadOnlyDictionary<int, string>>(GetFormatCodes);

        public static IReadOnlyDictionary<int, string> FormatCodes => _lazyFormatCodes.Value;
        ...
        private static IReadOnlyDictionary<int, string> GetFormatCodes()
        {
